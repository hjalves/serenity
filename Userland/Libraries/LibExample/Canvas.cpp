...
int const Canvas::WIDTH = 780;
int const Canvas::HEIGHT = 600;

Canvas::Canvas()
{
    m_bitmap = Gfx::Bitmap::try_create(Gfx::BitmapFormat::BGRx8888, { Canvas::WIDTH, Canvas::HEIGHT }).release_value_but_fixme_should_propagate_errors();
    draw();
}
